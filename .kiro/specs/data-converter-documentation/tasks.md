...
- [x] 6. カラー変換機能の実装
  ...
  - [x] 6.2 ColorPreviewコンポーネントの作成
    - `src/components/ColorPreview.tsx`を作成
    - リアルタイムカラープレビュー表示を実装
    - _Requirements: 3.5, 4.6_
  - [x] 6.3 ColorConverterコンポーネントの実装
